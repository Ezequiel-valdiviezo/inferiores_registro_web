      ...
      <div className="seccion2 row text-center mt-5" id='nosotros'>
        <div className='col-md-6'>
          ...
          <div className='mt-5 descripcionGintita px-5'>
            <p className='fw-bold'>Somos un centro de capacitación y formación de jugadores. Los entrenamos y preparamos para salida a AFA y mejorar su rendimiento.</p>
            <p className='fw-bold'>Creado por Daniel Cabrera, director técnico y coaching deportivo, el 18 de octubre del 2020</p>
            <button>Contacto</button>
            <p className='text-danger fw-bold mt-2'>*Los entrenamientos se realizan por la mañana</p>
          </div>
        </div>
        <div className='col-md-6'>
